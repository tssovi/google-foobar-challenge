<h1 align= "center"><b>Binary Bunnies</b></h1>
...
You must write a function solution(seq) that takes an array of up to 50 integers and returns a string representing the number (in base-10) of sequences that would result in the same tree as the given sequence.
